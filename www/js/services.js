  ...
  .factory('TwitterLib', function ($rootScope, $q, $window, $http, myAppConfig) {
    ...
    var Twitter = {
      ...
      init: function () {
        ...
        var openAuthoriseWindow = function (_url) {
          ...
          if (runningInCordova) {
            ...
            window.deferredLogin = deferredLogin; //TODO where is deferredLogin from?
          }
        };
      ...
      verify: function (_deferred) {
        ...
        // Javascript OAuth will take care of else for app we need to send only the options
      ...
      tweet: function (_message, _media) {
        ...
        return deferred.promise
          .then(Twitter.verify().then(function () {
            ...
            console.log('============================================================')
            console.log(oauth.getAccessToken()[0])
            console.log(oauth.getAccessToken()[1])
